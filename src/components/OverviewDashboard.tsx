...
export const OverviewDashboard: React.FC<OverviewDashboardProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/80 backdrop-blur-md border border-slate-800 rounded-xl p-5 sm:p-6 shadow-xl space-y-4 border-t-emerald-500/40">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="p-3 bg-[#0B0F17] border border-slate-800 rounded-lg space-y-1">
            ...
            <p className="text-lg font-bold font-mono text-white">
              ~{(14.5 + Math.min(currFiles, 50) * 0.48 + 12.0).toFixed(1)} <span className="text-xs font-normal text-slate-400">MB</span>
            </p>
            <span className="text-[10px] text-slate-500">Token buffers & symbol graphs</span>
          </div>
          ...
          <div className="p-3 bg-[#0B0F17] border border-slate-800 rounded-lg space-y-1">
            ...
            <p className="text-lg font-bold font-mono text-indigo-300">
              {isMemoryOptimized ? '15.4' : (14.5 + Math.min(currFiles, 50) * 0.35).toFixed(1)} <span className="text-xs font-normal text-indigo-400">MB</span>
            </p>
            <span className="text-[10px] text-slate-500">{isMemoryOptimized ? 'Optimal steady state' : 'Active buffer footprint'}</span>
          </div>
          ...
          <div className="p-3 bg-indigo-950/20 border border-indigo-800/30 rounded-lg space-y-1">
        ...
        <div className="p-3 bg-[#0B0F17] border border-slate-800 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 text-slate-300 flex-wrap">
            <span className="font-semibold text-white">Lifecycle Stages:</span>
            <span className="px-2 py-0.5 rounded bg-slate-800 text-slate-300 font-mono text-[11px]">1. Init (14.5 MB)</span>
            <span>&rarr;</span>
            <span className="px-2 py-0.5 rounded bg-slate-800 text-slate-300 font-mono text-[11px]">2. Ingest</span>
            <span>&rarr;</span>
            <span className="px-2 py-0.5 rounded bg-purple-950 text-purple-300 font-mono text-[11px]">3. AST Peak</span>
            <span>&rarr;</span>
            <span className={`px-2 py-0.5 rounded font-mono text-[11px] ${isMemoryOptimized ? 'bg-emerald-950 text-emerald-300 font-bold' : 'bg-slate-800 text-slate-400'}`}>
              4. {isMemoryOptimized ? 'Cleaned (15.8 MB)' : 'Held'}
            </span>
            <span>&rarr;</span>
            <span className="px-2 py-0.5 rounded bg-cyan-950 text-cyan-300 font-mono text-[11px]">5. Steady State</span>
          </div>
